...
- Create Angular project with ng: `ng new angularopendata.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularopendata.client.esproj`).
